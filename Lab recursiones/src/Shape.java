...
public class Shape extends JComponent {
    ...
    public static void shape(int n, double x, double y, double width, double height) {
        ...
        shape(n - 1, x + (newWidth * 1.5), y - (newHeight / 2), newWidth, newHeight);
        shape(n - 1, x + (newWidth * 1.5), y + (newHeight * 1.5), newWidth, newHeight);
        shape(n - 1, x - (newWidth /2), y + (newHeight *1.5), newWidth, newHeight);
        // Add your code here.
